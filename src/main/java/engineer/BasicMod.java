...
import engineer.util.KeywordInfo;
...
public class BasicMod implements
    ...
    public static void initialize() {
        new BasicMod();
        EngineerCharacter.Meta.registerColor();
    }
    ...
    public void receiveEditCharacters() {
        EngineerCharacter.Meta.registerCharacter();
    }

    @Override
    public void receiveEditCards() {
        new AutoAdd(modID)
            .packageFilter(EngineerCard.class)
            .setDefaultSeen(true)
            .cards();
    }
    ...
    public void receiveEditRelics() {
        BaseMod.addRelic(new Blueprint(), RelicType.SHARED);
    }
    ...
    public void receivePostBattle(AbstractRoom room) {
        if (AbstractDungeon.player instanceof EngineerCharacter) {
            ((EngineerCharacter)AbstractDungeon.player).clearAutomatons();
        }
    }
}
