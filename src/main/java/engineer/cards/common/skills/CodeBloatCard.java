...
public class CodeBloatCard extends EngineerCard {
    public final static String ID = BasicMod.makeID("codebloat");
    ...
    public void use(AbstractPlayer player, AbstractMonster enemy) {
        if (player instanceof EngineerCharacter) {
            ...
            engineer.program.add(new Program.DefenseCommand(4));
